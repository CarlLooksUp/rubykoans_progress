...
class AboutMessagePassing < EdgeCase::Koan
  ...
  def test_all_messages_are_caught
    ...
    assert_equal catcher.method_missing(:foobar), catcher.foobar
    assert_equal catcher.method_missing(:foobaz, [1]), catcher.foobaz(1)
    assert_equal catcher.method_missing(:sum, [1, 2, 3, 4, 5, 6]), catcher.sum(1,2,3,4,5,6)
  end
